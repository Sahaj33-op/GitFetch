  ...
  return (
    <div className="space-y-24 py-12">
      ...
      <section className="text-center max-w-3xl mx-auto px-4">
        <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6 bg-gradient-to-r from-blue-600 via-indigo-650 to-purple-600 dark:from-blue-400 dark:via-indigo-400 dark:to-purple-400 bg-clip-text text-transparent">
      ...
      <section className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="glass-panel p-6 rounded-2xl hover:shadow-md dark:hover:shadow-none hover:-translate-y-1 transition-all duration-300 flex flex-col">
            <div className="w-12 h-12 bg-blue-50/80 dark:bg-blue-950/40 text-blue-600 dark:text-blue-400 rounded-xl flex items-center justify-center mb-6">
              <Briefcase className="w-6 h-6" />
            </div>
            <h3 className="text-xl font-bold mb-3 text-zinc-900 dark:text-zinc-150">Portfolio Generation</h3>
          ...
          <div className="glass-panel p-6 rounded-2xl hover:shadow-md dark:hover:shadow-none hover:-translate-y-1 transition-all duration-300 flex flex-col">
            <div className="w-12 h-12 bg-purple-50/80 dark:bg-purple-950/40 text-purple-600 dark:text-purple-400 rounded-xl flex items-center justify-center mb-6">
              <Search className="w-6 h-6" />
            </div>
            <h3 className="text-xl font-bold mb-3 text-zinc-900 dark:text-zinc-150">Candidate Screening</h3>
          ...
          <div className="glass-panel p-6 rounded-2xl hover:shadow-md dark:hover:shadow-none hover:-translate-y-1 transition-all duration-300 flex flex-col">
            <div className="w-12 h-12 bg-amber-50/80 dark:bg-amber-950/40 text-amber-600 dark:text-amber-400 rounded-xl flex items-center justify-center mb-6">
              <Download className="w-6 h-6" />
            </div>
            <h3 className="text-xl font-bold mb-3 text-zinc-900 dark:text-zinc-150">Profile Backup</h3>
          ...
          <div className="glass-panel p-6 rounded-2xl hover:shadow-md dark:hover:shadow-none hover:-translate-y-1 transition-all duration-300 flex flex-col">
            <div className="w-12 h-12 bg-emerald-50/80 dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-400 rounded-xl flex items-center justify-center mb-6">
              <Shield className="w-6 h-6" />
            </div>
            <h3 className="text-xl font-bold mb-3 text-zinc-900 dark:text-zinc-150">Team & Org Audits</h3>
      ...
      {/* FAQs */}
      <section className="bg-zinc-50/30 dark:bg-zinc-900/10 py-16 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 border-t border-b border-zinc-200/50 dark:border-zinc-800/40">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-zinc-650 dark:text-zinc-400">Everything you need to know about authentication and extraction.</p>
          </div>
          
          <div className="space-y-6">
            <div className="glass-panel p-6 rounded-2xl border border-zinc-200/80 dark:border-zinc-800/80">
            ...
            <div className="glass-panel p-6 rounded-2xl border border-amber-250/70 dark:border-amber-900/30 bg-amber-50/20 dark:bg-amber-950/10 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-amber-50/30 dark:bg-amber-950/20 rounded-bl-[100px] -z-10"></div>
              <h3 className="text-lg font-bold text-zinc-900 dark:text-zinc-50 mb-2 flex items-center gap-2">
                <AlertCircle className="w-5 h-5 text-amber-600 dark:text-amber-500" />
                Why do I need a 7-day PAT token for organizations?
              </h3>
              <p className="text-zinc-650 dark:text-zinc-300 text-sm leading-relaxed mb-3">
                GitHub has strict policies for SAML/SSO enabled organizations. To view these organizations via the API:
              </p>
              <ul className="list-disc pl-5 text-zinc-650 dark:text-zinc-300 text-sm space-y-1.5">
